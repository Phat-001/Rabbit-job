...
if (isset($postId) && !empty($postId)) {
  $post = findWhere('posts', 'post_id', $postId, 1, $_SESSION['id_user']);
      ...
      <div class="col-md-8 offset-md-2 col-sm-10 offset-sm-1">
        ...
        <div class="jumbotron">
          ...
          <p class="lead text-justify">
            ...
            <a class="btn btn-primary btn-lg" href="<?= $link ?>" role="button">Trở về</a>

            <?php if ($_SESSION["id_user"] == $post["account_id"]) : ?>

              <?php $link = str_replace("post.php", "editPost.php?postid=" . $post['post_id'], $_SERVER["PHP_SELF"]); ?>
              <a class="btn btn-warning btn-lg" href="<?= $link ?>" role="button">Sửa</a>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
                      ...
                      <?php $link = str_replace("post.php", "deletePost.php?postid=" . $post['post_id'], $_SERVER["PHP_SELF"]) ?>

                      <button type="button" class="btn btn-secondary" data-dismiss="modal">Đóng</button>
                      <a type="submit" name="deletePost" href="<?= $link ?>" class="btn btn-primary">Xóa</a>
                    </div>
                  </div>
                </div>
              </div>
